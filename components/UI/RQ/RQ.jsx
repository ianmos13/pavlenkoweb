        ...
        <div className={styles.topContainer}>
          <div className={styles.block}>
            ...
            <div className={styles.textContainer}>
              <a className={styles.linkText} href={`mailto:${data.PartnerMail}`}>{data.PartnerMail}</a>
            </div>
          </div>
          <div className={styles.block}>
            <h3>Резидентам</h3>
            <div className={styles.textContainer}>
              <a className={styles.linkText} href={`mailto:${data.ResidentMail}`}>{data.ResidentMail}</a>
            </div>
          </div>
          <div className={styles.block}>
            <h3>СМИ</h3>
            <div className={styles.textContainer}>
              <a className={styles.linkText} href={`mailto:${data.SMIMail}`}>{data.SMIMail}</a>
            </div>
          </div>
		  <div className={styles.block}>
  <h3>Наши соц сети</h3>
    ...
    <div className={styles.iconContainer}>
      {data.tg && (
        <Link className={styles.link} href={data.tg}>
          <Image className={styles.image} src={TelegramIcon} alt="Telegram" />
        </Link>
      )}
    </div>
    <div className={styles.iconContainer}>
