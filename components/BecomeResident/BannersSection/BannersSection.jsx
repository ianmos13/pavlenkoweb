...
const BannersSection = () => {
  ...
  const { data: bannersData, loading, error } = useFetch(`/become-resident-banner-sliders?populate=*&pagination[pageSize]=${PAGE_SIZE}`);
    ...
    <div>
      <Loader loading={loading}>
        {formattedBannersData.length > 0 ? (
          <BannerSlider data={formattedBannersData} size={"medium"} theme={"light"} />
        ) : (
